...
import { FileMetadata } from '@officexapp/framework';
...
const SheetJSPreview: React.FC<SheetJSPreviewProps> = ({ file, rowCount = 50, maxPreviewSize = 1, showButtons = true }) => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const jsonData: SheetRow[] = utils.sheet_to_json(worksheet, { header: 1 });
