...
import { DirectoryResourceID, DiskID, UserID } from "@officexapp/types";
    ...
    if (newFolderName.trim()) {
      try {
        ...
        const createAction = {
          ...
          target: {
            resource_id: "" as DirectoryResourceID, // This will be auto-generated by the action creator
          },
          payload: {
            name: newFolderName,
            parent_folder_id: uploadFolderPath.split("/").pop() || "",
